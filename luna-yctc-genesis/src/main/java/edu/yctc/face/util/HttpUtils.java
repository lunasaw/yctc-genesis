...
public class HttpUtils {
    ...
    public static void post(String url, final Map<String, String> params, byte[] file, Callback callback) {
        Map<String, byte[]> fileParams = Maps.newHashMapWithExpectedSize(10);
     ...
     * 带文件参数的请求
     */
    public static void post(String url, final Map<String, String> params, Map<String, byte[]> file1,
        Map<String, byte[]> file2, Callback callback) {
        try {
            // 构建请求体
     ...
     * 构建请求参数
     */
    private static RequestBody buildRequestBody(final Map<String, String> params, Map<String, byte[]> filePath1,
        Map<String, byte[]> filePath2) throws Exception {
        // 普通参数
    ...
    private static void addFileParams(MultipartBody.Builder bodyBuilder, String key, byte[] file) throws Exception {
        bodyBuilder.addFormDataPart(key, key, RequestBody.create(MEDIA_TYPE_APPLICATION, file));
    }
    ...
    private static void addFileParamsByKey(Map<String, byte[]> filePath,
        MultipartBody.Builder bodyBuilder) throws Exception {
        if (null != filePath) {
    ...
    private static void getDataByKey(Map<String, byte[]> file, String key,
        MultipartBody.Builder bodyBuilder) throws Exception {
