package edu.yctc.common.utils.poi;
...
import edu.yctc.common.utils.reflect.ReflectUtils;
import edu.yctc.common.utils.text.Convert;
import edu.yctc.framework.aspectj.lang.annotation.Excel;
import edu.yctc.framework.aspectj.lang.annotation.Excels;
...
public class ExcelUtil<T>
{
    ...
    {
	    System.out.println("初始化表格信息:"+sheetName+"类型 字段类型（0：导出导入；1：仅导出；2：仅导入）"+ Excel.Type.EXPORT);
    ...
    {
        String downloadPath = GenesisConfig.getDownloadPath() + filename;
