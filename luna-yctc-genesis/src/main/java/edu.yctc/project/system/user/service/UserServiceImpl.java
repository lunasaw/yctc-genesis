package edu.yctc.project.system.user.service;
...
import edu.yctc.framework.aspectj.lang.annotation.DataScope;
import edu.yctc.framework.shiro.service.PasswordService;
import edu.yctc.project.system.config.service.IConfigService;
import edu.yctc.project.system.post.domain.Post;
import edu.yctc.project.system.post.mapper.PostMapper;
import edu.yctc.project.system.role.domain.Role;
import edu.yctc.project.system.role.mapper.RoleMapper;
import edu.yctc.project.system.user.domain.User;
import edu.yctc.project.system.user.domain.UserPost;
import edu.yctc.project.system.user.domain.UserRole;
import edu.yctc.project.system.user.mapper.UserMapper;
import edu.yctc.project.system.user.mapper.UserPostMapper;
import edu.yctc.project.system.user.mapper.UserRoleMapper;
