package edu.yctc.project.common;

import javax.servlet.http.HttpServletRequest;
import javax.servlet.http.HttpServletResponse;

import edu.yctc.framework.config.GenesisConfig;
import edu.yctc.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
	        ...
	        log.info("截取'_'后部分的文件名,根据时间返回修正文件名:==>"+realFileName);
            String filePath = GenesisConfig.getDownloadPath() + fileName;
