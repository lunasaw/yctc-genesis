...
public class FaceAttributes {
    ...
    public String toString() {
        return "{" + "\"gender\":" + gender + ", \"age\":" + age + ", \"smile\":" + smile + ", \"headpose\":" + headpose
            + ", \"facequality\":" + facequality + ", \"blur\":" + blur + ", \"eyestatus\":" + eyestatus
            + ", \"emotion\":" + emotion + ", \"glass\":" + glass + ", \"ethnicity\":" + ethnicity + ", \"beauty\":"
            + beauty + ", \"mouthstatus\":" + mouthstatus + ", \"eyegaze\":" + eyegaze + ", \"skinstatus\":"
            + skinstatus + '}';
    }
}
